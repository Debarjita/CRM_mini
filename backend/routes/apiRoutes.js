// routes/apiRoutes.js - Additional API endpoints
...
const swaggerOptions = {
  definition: {
    ...
    info: {
      title: 'Mini CRM API',
      version: '1.0.0',
      description: 'Comprehensive CRM Platform API with AI Integration',
    },
    servers: [
      {
 ...
 *         visits:
 *           type: number
 *           description: Number of visits/sessions
 *         lastVisit:
 *           type: string
 *           format: date-time
 ...
 *     responses:
 *       202:
 *         description: Order data queued for processing
 *       500:
...
module.exports = {
  ...
  seedDatabase: async () => {
    const { sampleCustomers, sampleOrders } = require('./sample-data');
 ...
 *             type: string
 *           description: Customer tags/categories
 */
 ...
 *     responses:
 *       202:
 *         description: Customer data queued for processing
 *       400:
 ...
 * /api/campaigns:
 *   get:
 *     summary: Get all campaigns for authenticated user
 ...
 *               description:
 *                 type: string
 *                 example: "Customers who spent over ₹10,000 and haven't visited in 90 days"
 *     responses:
 *       200:
 ...
 *   post:
 *     summary: Get AI-powered message suggestions
 *     tags: [AI Features]
 *     security:
 *       - googleOAuth: []
 *     requestBody:
 ...
 *     responses:
 *       200:
 *         description: Message suggestions generated
 *         content:
 *           application/json:
 *             schema:
 *               type: object
